/* $Id: RSACipher_OAEP.java,v 1.2 2003/02/20 02:43:39 gelderen Exp $
 *
...
//        if (!mode.equalsIgnoreCase("ECB"))
        ...
        throws BadPaddingException, IllegalBlockSizeException
    {
        ...
        BigInteger m = null;
        try {
            m = RSAAlgorithm.rsa(c, _n, _exp, _p, _q, _u);
        } catch(ArithmeticException ex) {
            throw new BadPaddingException(
                "ArithmeticException during decrypt! Bad key perhaps?");
        }
        ...
        throws IllegalBlockSizeException
    {
        ...
        BigInteger c = null;
        try {
            c = RSAAlgorithm.rsa(m, _n, _exp, _p, _q, _u);
        } catch(ArithmeticException ex) {
            throw new IllegalBlockSizeException(
                "ArithmeticException during encrypt! Bad key perhaps?");
        }
