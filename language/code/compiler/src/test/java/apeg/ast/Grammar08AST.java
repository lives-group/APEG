...
public class Grammar08AST {
	...
	public static void main(String args[]){
		...
		syn.add(new Pair<Type, Expr>(new TyBool(new SymInfo(8, 11)), new Attribute(new SymInfo(8, 16), "b")));
		syn.add(new Pair<Type, Expr>(new TyInt(new SymInfo(8, 19)), new Attribute(new SymInfo(8, 23), "na")));
		syn.add(new Pair<Type, Expr>(new TyInt(new SymInfo(8, 27)), new Attribute(new SymInfo(8, 31), "nb")));
		syn.add(new Pair<Type, Expr>(new TyInt(new SymInfo(8, 35)), new Attribute(new SymInfo(8, 39), "nc")));
		...
		syn.add(new Pair<Type, Expr>(new TyInt(new SymInfo(12, 11)), new Attribute(new SymInfo(12, 15), "na")));
		...
		syn = new ArrayList<Pair<Type, Expr>>();
		syn.add(new Pair<Type, Expr>(new TyInt(new SymInfo(18, 11)), new Attribute(new SymInfo(18, 15), "nb")));
		...
		syn = new ArrayList<Pair<Type, Expr>>();
		syn.add(new Pair<Type, Expr>(new TyInt(new SymInfo(24, 11)), new Attribute(new SymInfo(24, 15), "nc")));
