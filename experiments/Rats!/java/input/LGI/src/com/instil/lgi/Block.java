 ...
 * indices of <tt>getBegin()</tt> (inclusive) and <tt>getEnd()</tt> (exclusive).</p>
 * <p>
 * @author Edgar A Duenez-Guzman
 */
public class Block
{
     ...
     * parsing of a String fails. It is safe to compare directly using the == and
     * != operators against this Block to test for parsing errors.
     */
    public static final Block NO_PARSE = new Block( "NoParse", 0, 7 );
    //The reference to the String parsed.
    private String text;
    //An user object, used during optimization to store arbitrary "semantic value"
    private Object user;
    //The numerical type of this Block. This is provided as a mean to quickly identify parsed Blocks.
    private int type;
    //The starting (inclusive) and ending (exclusive) positions in the parsed String
     ...
     */
    public Block() { super(); children = new Vector<Block>(); text = ""; }
    /**
     * Creates a new instance of Block with the specified region in the provided,
     * String as the parsed area of the String. By convention, all sub-Blocks
     * should refer to the same String reference, and use a subset (not necessarily
     * proper) of the portion used by this Block. This is not enforced though.
     * @param text The reference to the parsed String that generated this Block.
     * @param begin The starting (inclusive) position in the String corresponding
     *        to the contents of this Block.
     * @param end The ending (exclusive) position in the String corresponding
     *        to the contents of this Block.
     */
     ...
     * add the Blocks given in the array as its children. </p>
     * <p>
     * By convention, all sub-Blocks should refer to the same String reference,
     * and use a subset (not necessarily proper) of the portion used by this Block.
     * This is not enforced though. </p>
     * @param text The reference to the parsed String that generated this Block.
     * @param begin The starting (inclusive) position in the String corresponding
     *        to the contents of this Block.
     * @param end The ending (exclusive) position in the String corresponding
     *        to the contents of this Block.
     * @param type The numerical type to be given to this Block.
     * @param child The array of children. These will be referenced and not
     *        copied. The array can be null or of length zero in which case, the
     *        Block will be considered a terminal (leaf) node.
     */
     ...
     * to fit the number of children.
     * This function resets the terminal status of the block to true if and only
     * if the number of children is zero.
    ...
    /**
     * Adds the specified Block to the end of list of children of this node. If the
     * same Block is added to 2 or more Blocks (even if it is the same) in the
     * same parsed tree the results are undefined. This function only references
     * the Block, and does not copy it.
     * @param block The Block to be added as child of this Block.
     */
    public void addChild( Block block ) { children.add( block ); }
    /**
     ...
     */
    public Block getChild( int i ) { return children.get(i); }
    /**
     ...
     * @param t The new type of this Block.
     */
    ...
    /**
     * Utility method that creates a copy of the region in the parsed String that
     * this Block contains. This is equivalent to calling
     * <tt>getText().substring( getBegin(), getEnd() )</tt>
     * @return A copy of the region of interest as a String.
     */
    public String getSubtext() { return text.substring( begin, end ); }
     ...
     * @param t The new reference to the text contained in this Block.
     */
     ...
     */
    public Object getUserObject() { return user; }
    /**
     * Sets a reference to the provided Object to be used as the user-defined
     * data contained in this Block.
     * @param u The new user Object for this Block.
     */
    public void setUserObject( Object u ) { user = u; }
     ...
     * @param b The new starting index to be used.
     */
    public void setBegin( int b ) { begin = b; }
     ...
     * @param e The new finishing index to be used.
     */
...
//----------------------------- Object ---------------------------
    ...
    public String toString()
    {
        ...
        for( int i = 0; i < level; i++ )
            indent += "  ";
        indent += "Block (" + text.substring( begin, end ).replaceAll( "[\\r\\n]", "\\\\n" ) + "), type [" + type + "]\n";
        level++;
