...
public class ParseError extends Object
{
     ...
     * and the specified position in the text at which this error happened.
     * This constructor will initialize the line number and in-line position of
     * the actual cause of this error to facilitate its manipulation.
     * @param source The source text of the error (attempted to parse).
     * @param pos The index in the String at which this error is claimed to have
     *        occurred.
     */
    public ParseError( String source, int pos )
    {
        ...
        line = 0;
        origPosition = pos;
        //Compute the actual line/place where this error happened in the String.
        do
        {
            line++;
            current = newLine + NEW_LINE_SIZE;
            newLine = source.indexOf( NEW_LINE, current );
            //System.out.println( "New line at " + newLine + " Current = " + current );
        } while( newLine >= 0 && newLine < pos );
        position = pos - current + 1;
    }
    /**
     * Adds a possible cause for a ParseError to this error.
     * @param msg The message to attach to the cause.
     * @param type The type of Block that is claimed to generate the error.
     */
     ...
     */
    public int getOrigPosition() { return origPosition; }
    /**
     ...
     */
    public Vector<String> getCauses() { return causes; }
    /**
     * Gets a reference to the list of causes associated with this error.
     * @return The causes as a Vector of integers (types of Blocks).
     */
    public Vector<Integer> getTypes() { return types; }
     ...
     * @param type The type of Blocks to ignore error causes from.
     */
