...
//   Version 1.7
//    150629 Generate 'acceptPred' and 'rejectPred' instead of
//           'acceptAnd', 'acceptNot', 'rejectAnd', 'rejectNot'.
//           Do not generate 'boolReject'.
//    150724 Genarate call to 'closeParser' instead of 'failure'.
//
//=========================================================================
...
public class Generate
{
  ...
  void generate()
    {
      ...
      out.BOX("This file was generated by Mouse 1.7 at " +
      ...
      out.line("    sem.init();");
      out.line("    boolean result = " + peg.rules[0].name + "();");
  ...
  void genSkel()
    {
      ...
      //  Create header.
      //---------------------------------------------------------------
      out.BOX("This skeleton was generated by Mouse 1.7 at " + date + " GMT\n" +
               "from grammar '" + gramPath + "'.");
      out.line("");
  ...
  class ProcVisitor extends mouse.peg.Visitor
  {
    ...
    public void visit(Expr.And expr)
      {
        out.line("if (!" + ref(expr.expr) + ") return rejectPred(" + cache + ");");
