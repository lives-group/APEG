...
/*		if(dataStructure_.getReservationStation().getAddList().get(i).getQj() != 0 ||
		...
		if(time == 0){
				...
				dataStructure_.getReservationStation().getLoadList().get(i).setA(dataStructure_.getReservationStation().getLoadList().get(i).getA() +
	...
	public boolean write(int i) {
			...
			int b = dataStructure_.getReservationStation().getLoadList().get(i).getDest();
	...
	public void commit(){
		if(dataStructure_.getReorderBuffer_().getROBList().get(0).state == "Escrita"){
			if (!dataStructure_.getReorderBuffer_().getBusy(0)){
				...
				dataStructure_.getRegisters_().setReg(d, dataStructure_.getReorderBuffer_().getValue(0));
				//dataStructure_.getReorderBuffer_().setBusy(0, false);
				if(dataStructure_.getRegisterStatus_().getReorder(d) == dataStructure_.getReorderBuffer_().getDest(0)){
